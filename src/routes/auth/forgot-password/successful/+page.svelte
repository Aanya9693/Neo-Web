	...
	>
		...
		<div class="flex justify-center items-center flex-col">
			...
			<div class="text-center pt-4 2xl:pt-10 md:w-2/3">
				<p
					class="text-[16px] font-medium text-center text-[#081B2A] text-barlow mb-10 md:mx-24 !leading-6"
				>
					Your password is reset now, You can login to your account now
				</p>
